            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      info@morkivilcim.com<br />
                      destek@morkivilcim.com
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="w-10 h-10 bg-mor-600 rounded-lg flex items-center justify-center text-white hover:bg-mor-700 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
